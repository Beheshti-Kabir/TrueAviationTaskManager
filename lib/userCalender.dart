...
class UserCalenderPage extends StatefulWidget {
  @override
  _userCalender createState() => _userCalender();
...
class _userCalender extends State<UserCalenderPage> {
  ...
  getData() async {
    ...
    response = await http.post(
        ...
        Uri.parse('https://trueaviation.aero/FairEx/api/v1/met/task/date'),
        headers: <String, String>{
          'Content-Type': 'application/json',
          'Accept': 'application/json',
          'Authorization': token
