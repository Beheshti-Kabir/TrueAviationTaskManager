...
class UserTaskViewPage extends StatefulWidget {
  const UserTaskViewPage({Key? key}) : super(key: key);

  @override
  _UserTaskViewPageState createState() => _UserTaskViewPageState();
}

class _UserTaskViewPageState extends State<UserTaskViewPage> {
  callBack() {
    setState(() {});
    getTaskData();
  }
  ...
  getTaskData() async {
    ...
    String URL_GetTaskData =
        'https://trueaviation.aero/FairEx/api/v1/met/task/' +
                                                    ...
                                                    return Padding(
                                                      ...
                                                      child: Row(
                                                        children: [
                                                          ...
                                                          //                         // shape:
                                                          //                         //     CircleAvatar
                                                          //                         title: Text('Change Status', style: GoogleFonts.mcLaren(color: Colors.tealAccent, fontWeight: FontWeight.bold)),
                                                          //                         content: Text('Sub Task: ' + subTaskTiteList[index].toString() + '\nThis Sub Task is ' + subTaskStatusList[index].toString() + '\nDo you wanna change the status?', style: GoogleFonts.mcLaren(color: Colors.tealAccent)),
                                                          //                         actions: <Widget>[
                                                          //                           TextButton(
...
class _ShowDialogState extends State<ShowDialog> {
  ...
  getSearchData() async {
    ...
    String URL = 'https://trueaviation.aero/FairEx/api/v1/met/search/' +
